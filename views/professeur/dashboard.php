...
if (isset($_GET['status'])) {
    switch ($_GET['status']) {
        ...
        case 'student_added':
            ...
            break;
        case 'no_class':
            $statusMessage = 'Aucune classe n’est affectée à ce professeur. Impossible de créer une évaluation.';
            $statusType = 'error';
            break;
        case 'invalid_class':
            $statusMessage = 'Classe invalide ou non affectée. Choisissez une classe active.';
            $statusType = 'error';
            break;
        case 'no_subject':
            $statusMessage = 'Aucune matière associée à ce professeur. Impossible de créer une évaluation.';
            $statusType = 'error';
            break;
        case 'error':
        ...
        <main class="student-main">
            ...
            <section class="section-block">
                ...
                <div class="form-grid" style="display:flex; justify-content:center;">
                    ...
                    <div class="teacher-form-box" style="width: 550px;">
                        <h3><i class='bx bx-calendar-plus' style="margin-right:8px;"></i>Créer une évaluation</h3>
                        <?php if (empty($classes)): ?>
                            <div class="form-hint" style="border-color:#fee2e2;background:#fef2f2;color:#991b1b;">
                                Aucune classe n’est affectée à votre compte. Contactez l’administrateur pour qu’il vous assigne une classe avant de créer une évaluation.
                            </div>
                        <?php else: ?>
                ...
                <div class="table-card">
                    <table>
                        ...
                        <tbody>
                            <?php if (count($evaluations) > 0): ?>
                                <?php foreach ($evaluations as $eval): ?>
                                    ...
                                    foreach ($classes as $c) {
                                        if ($c['Id_Classe'] == $evalClasse) {
                                            $classeLabel = $c['libelle'];
                                            break;
                                        }
                                    }
                                    ?>
                            ...
                            <?php else: ?>
                                <tr>
                                    <td colspan="5" style="text-align:center;padding:24px;">Aucune évaluation créée.</td>
                                </tr>
                            <?php endif; ?>
                        </tbody>
                    </table>
